...
func TestSimulateGoldenZeroAero(t *testing.T) {
	...
	pinDiagnostics(t, d, map[string]string{
		...
		"MaxAlphaSup":     "15.998552903546702",
		...
		"CrossUpH":        "94133.99354681373",
		"CrossUpStage":    "2",
		"CrossDownTime":   "2798.599999998554",
		"BurnoutT":        "139.79999999999825",
		"BurnoutV":        "7421.260689797114",
		"BurnoutH":        "206345.31043150742",
		"BurnoutTheta":    "22.18337761080337",
		"ApogeeT":         "1451.1999999997793",
		"ApogeeH":         "2.216906384513257e+06",
		"ImpactT":         "2827.822265623527",
		"ImpactRange":     "1.2747352126049245e+07",
		"GroundHitStage":  "0",
	})
}
...
func TestSimulateGoldenWithAero(t *testing.T) {
	...
	pinDiagnostics(t, d, map[string]string{
		...
		"MaxAlphaSup":     "10.036191007955725",
		"MaxPitchRate":    "2.997022033095309",
		"MaxPitchRateNum": "3.027442781117401",
		"PitchRateSep1":   "0",
		"PitchRateSep2":   "1.5472707971050502e-13",
		"CrossUpTime":     "102.39999999999795",
		"CrossUpH":        "94031.68711977638",
		"CrossUpStage":    "2",
		"CrossDownTime":   "2587.399999998746",
		"BurnoutT":        "139.79999999999825",
		"BurnoutV":        "7363.753197935853",
		"BurnoutH":        "181731.5292812595",
		"BurnoutTheta":    "20.236945440774313",
		"ApogeeT":         "1348.2999999998729",
		"ApogeeH":         "1.8977145353181763e+06",
		"ImpactT":         "2631.593749998706",
		"ImpactRange":     "1.2427359351846611e+07",
		"GroundHitStage":  "0",
	})
}
